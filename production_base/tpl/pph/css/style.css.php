...
#header_logo {
  background: url('<? echo $sTemplate->getTemplateRoot(); ?>img/header_logo_pph.png');
  height: 44px;
  width: 126px;
  position: relative;
  left: 14px;
...
.spellcheck_button {
  background: url('<? echo $sTemplate->getTemplateRoot(); ?>img/icon_spellcheck.gif');
...
.spellcheck_button:hover {
  background: url('<? echo $sTemplate->getTemplateRoot(); ?>img/icon_spellcheck_hover.gif');
}
