...
<head>
  ...
  <script type='text/javascript' src='<? echo $sTemplate->getTemplateRoot(); ?>js/jquery.dcspamless.1.0.min.js'></script>
  <script type='text/javascript' src='<? echo $sTemplate->getTemplateRoot(); ?>lib/cookieconsent2/cookieconsent.js'></script>
  ...
  <script type="text/javascript">
    window.cookieconsent_options = {
      ...
      "learnMore":"<? echo $sTemplate->getString("DATA_PRIVACY_STATEMENT"); ?>",
      "link":"<? echo $sTemplate->getString("DATA_PRIVACY_STATEMENT_URL"); ?>",
      "theme":"<? echo $sTemplate->getTemplateRoot(); ?>lib/cookieconsent2/build/dark-top.css"
    };
