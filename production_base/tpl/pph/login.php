...
<div id = "content_wide">
  ...
  <div class="headline"><? echo $sTemplate->getString("HEADER_LOGIN"); ?></div>
  ...
  <div class = "login">
    <form id = "form_login" action = "<? echo $sTemplate->getRoot(); ?>login/" method = "POST">
      ...
      <div class = "row row_submit">
        ...
        <button class = "button_blue" onclick = "wikiargument.passRequest(); return false;"><? echo $sTemplate->getString("LOGIN_FORGOT_PASSWORD"); ?></button>
      </div>
