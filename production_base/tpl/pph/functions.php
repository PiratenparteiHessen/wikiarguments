...
<div class = "question'.($tabs ? ' question_no_margin' : '').'" id = "question_'.$q->questionId().'">
  ...
  <div class = "question_details">
    <!-- pph edit<a href=#arguments class="button_orange" style="width:180px;">'.$sTemplate->getString("QUESTION_GOTO_ARGUMENTS").'</a>-->
'.$q->details().'</div>
      ';
    }
    ...
    }else
    {
        ...
        $ret .= '<div class = "author question_author">'.$sTemplate->getString("QUESTION_AUTHOR", Array("[TIMESINCE]", "[USERNAME]"), Array($q->timeSince(), $q->author())).'</div>';
    }
